 ...
 * RSelect.h                                                                  *
 *                                                                            *
 * Description: This is the header file of a Select() generic wrapper. It     *
 *              ensures robustness and facility of use. It stores a pool of   *
 *              file descriptors that are used for select(). Each file        *
 *              descriptor is coupled with a callback function that is        *
 *              invoked whenever select() detects activity. The callback      *
 *              function takes a pointer to the file descriptor's stored      *
...
/* GSelect: Monitors the pool and invokes callback function when appropriate.
